  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        accent:
          "gradient-accent text-accent-foreground shadow-soft hover:shadow-glow-accent hover:scale-[1.02] active:scale-[0.98]",
        hero:
          "gradient-hero text-primary-foreground shadow-medium hover:shadow-glow hover:scale-[1.02] active:scale-[0.98]",
        premium:
          "gradient-premium text-foreground shadow-medium hover:shadow-strong hover:scale-[1.02] active:scale-[0.98]",
      },
      size: {
